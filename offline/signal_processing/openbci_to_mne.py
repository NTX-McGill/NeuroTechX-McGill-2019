...
# Authors: Teon Brooks <teon.brooks@gmail.com>, Daniel Rivas <rivasdaniel1992@gmail.com>, Jenisha
#
...
class RawOpenBCI(BaseRaw):
    ...
    misc : list or tuple
        ...
        Default is (-4,-3, -2, -1), which are the accelerator sensors and timestamp column.
...
test = read_raw_openbci(fname_20)